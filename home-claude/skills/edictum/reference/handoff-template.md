...
Copy into `docs/tasks/HANDOFF-<slug>.md` (project-local). Written by the outgoing
...
- Prior verdicts: `docs/tasks/results/<spec>-verdict.md` (pipeline-runner output)
- Pending specs: `docs/tasks/<file>` (executor, effort) — in intended order
